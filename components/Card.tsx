	...
	return (
		<StyledCardWrapper isNew={isNew}>
			...
			<StyledCardBody>
				...
				<StyledAuthorWrapper>
					<StyledAuthorImage src={authorImage.default} alt="" />
					<StyledAuthorName>{name}</StyledAuthorName>
				</StyledAuthorWrapper>
				<StyledCardInfoWrapper>
					<StyledCardInfo>
						<StyledCardInfoImage src={dateIcon.default} alt="" />
						{isNew ? (
							<StyledInput />
						) : (
							<StyledCardInfoText>{moment(startAt).format('YYYY년 MM월 DD일 dddd')}</StyledCardInfoText>
						)}
					</StyledCardInfo>
					<StyledCardInfo>
						<StyledCardInfoImage src={clockIcon.default} alt="" />
						{isNew ? (
							<StyledInput />
						) : (
							<StyledCardInfoText>{`${moment(startAt).format('HH시 mm분')} ~ ${moment(startAt)
								.add('hour', duration.split(':')[0])
								.add('minute', duration.split(':')[1])
								.format('HH시 mm분')} `}</StyledCardInfoText>
						)}
					</StyledCardInfo>
					<StyledCardInfo>
						<StyledCardInfoImage src={placeIcon.default} alt="" />
						{isNew ? <StyledInput /> : <StyledCardInfoText>{`${address1} ${address2}`}</StyledCardInfoText>}
					</StyledCardInfo>
				</StyledCardInfoWrapper>
				{isNew ? (
					...
					<>
						...
						<StyledFixBoxWrapper>
							...
							<StyledFixBoxBlue>
								...
								<StyledVoteImage src={checkIcon.default} alt="" />
							</StyledFixBoxBlue>
						</StyledFixBoxWrapper>
					</>
				)}
